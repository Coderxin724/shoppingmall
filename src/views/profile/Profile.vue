<template>
  <div id="profile">
    <nav-bar class="nav-bar"><div slot="center">Xin-VS-Code商城</div></nav-bar>
...
export default {
  ...
  data: function() {
    return {
      orderList: [
        {
          icon: "iconfont icon-xiaoxi_huaban1",
          iconColor: "#ff8198",
          info: "我的消息"
        },
        {
      ...
      serviceList: [
        ...
        { icon: "iconfont icon-app", iconColor: "#ff8198", info: "下载购物APP" }
      ]
    };
  },
  mounted: function() {}
